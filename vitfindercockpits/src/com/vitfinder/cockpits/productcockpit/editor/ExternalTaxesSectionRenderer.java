 ...
 *
 */
package com.vitfinder.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("vitfindercockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("vitfindercockpits.product.externalTaxes"));
