 ...
 *
 */
package com.vitfinder.cockpits.setup;
...
import com.vitfinder.cockpits.constants.VitfinderCockpitsConstants;
 ...
 */
@SystemSetup(extension = VitfinderCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(VitfinderCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(VitfinderCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						VitfinderCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/vitfindercockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
