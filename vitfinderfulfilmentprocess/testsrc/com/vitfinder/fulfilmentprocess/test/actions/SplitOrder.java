 ...
 *
 */
package com.vitfinder.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(VitfinderFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(VitfinderFulfilmentProcessConstants.PARENT_PROCESS);
