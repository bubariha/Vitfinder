 ...
 *
 */
public abstract class VitfinderAbstractEmailContext<T extends BusinessProcessModel> extends VelocityContext
{
	private static final Logger LOG = Logger.getLogger(VitfinderAbstractEmailContext.class);
