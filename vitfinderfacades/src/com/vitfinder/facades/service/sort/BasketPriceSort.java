 ...
 *
 */
public class BasketPriceSort extends AbstractBasketSort
{

	public static final String sort = "price-desc";
	...
	public CartModel updateGenericCartEntry() throws CommerceCartModificationException
	{
		...
		for (final CartModel cart : retailerBaskets)
		{
			...
			updateCartEntries(cart, sort, ":price-desc:retailer:" + retailer);
