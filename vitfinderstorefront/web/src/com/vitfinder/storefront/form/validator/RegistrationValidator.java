...
public class RegistrationValidator implements Validator
{
	...
	{
		addressValidator.validate(object, errors);
		...
		if (!registerForm.isRegisterCheckbox())
		{
			errors.reject("register.error.terms.not.accepted", "register.error.terms.not.accepted");
		}
