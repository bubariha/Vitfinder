 ...
 */
@Component("vitfinderAddressValidator")
public class AddressValidator implements Validator
{
	...
	{
		final RegisterForm addressForm = (RegisterForm) object;
		validateStandardFields(addressForm, errors);
		validateCountrySpecificFields(addressForm, errors);
	}

	protected void validateStandardFields(final RegisterForm addressForm, final Errors errors)
	{
	...
	protected void validateCountrySpecificFields(final RegisterForm addressForm, final Errors errors)
	{
