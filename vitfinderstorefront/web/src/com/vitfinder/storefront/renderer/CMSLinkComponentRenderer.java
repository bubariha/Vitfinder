 ...
 *
 */
package com.vitfinder.storefront.renderer;
...
import de.hybris.platform.cms2.constants.GeneratedCms2Constants.Enumerations.LinkTargets;
			...
			throws ServletException, IOException
	{
		try
		{
			...
			else
			{
				...
				if (component.getTarget() != null && !LinkTargets.SAMEWINDOW.equalsIgnoreCase(component.getTarget().toString()))
				{
				...
				{
					out.write("<img src=" + component.getMedia().getUrl() + ">");
				}
				else
				{

					final List<CMSNavigationNodeModel> navNodes = component.getNavigationNodes();
					for (final CMSNavigationNodeModel cmsNavigationNodeModel : navNodes)
					{

						final String navNode = "SocialNavNode";
						if (cmsNavigationNodeModel.getUid().equals(navNode))
						{
							//no logic
							flag = true;
						}
