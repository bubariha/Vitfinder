 ...
 *
 */
package com.vitfinder.storefront.controllers;
	...
	interface Views
	{
		...
		interface Pages
		{
			interface Account
			{
				...
				String AccountQuizResultsPage = "pages/account/accountQuizResultsPage";
				String StudyMyBand = "pages/account/studymyband";
				String StudyMyBandDetialsPage = "pages/account/studymybanddetailspage";
				String AccountArticlesPage = "pages/account/accountArticlesPage";
			...
			interface Cart
			{
				...
				String ComparePage = "pages/cart/comparePage";
				String SummaryPage = "pages/cart/retailerCartSummary";
				String RetailerPage = "pages/cart/retailerPage";
			}
			...
			interface Misc
			{
				...
				String QuickTipsPage = "pages/misc/quickTipsPage";
				String ArticlesPage = "pages/misc/articleLandingPage";
				String GeneralConditionsPage = "pages/misc/generalConditionsPage";
				String ConditionPage = "pages/misc/conditionPage";
			}
			...
			interface Product
			{
				...
				String Questionary = "pages/product/questionaryPage";
				String SymptomsCategory = "pages/product/symptomsCategoryPage";
		...
		interface Fragments
		{
			interface Cart
			{
				...
				String DeliveryCostPopup = "fragments/cart/deliveryCostPopup"; // vtf-40
			}
