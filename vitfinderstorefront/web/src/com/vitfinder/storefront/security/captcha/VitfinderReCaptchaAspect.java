 ...
 *
 */
package com.vitfinder.storefront.security.captcha;
...
public class VitfinderReCaptchaAspect
{
		...
		if (captcaEnabledForCurrentStore)
		{
			...
			if (request != null)
			{
						...
						|| !checkAnswer(request, challengeFieldValue, responseFieldValue))
				{
					...
					final Model model = (Model) CollectionUtils.find(args, PredicateUtils.instanceofPredicate(Model.class));
					GlobalMessages.addErrorMessage(model, "recaptcha.challenge.field.invalid");
