...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/vitfinderstorefront/electronics/en",
						"https://electronics.local:9002/vitfinderstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/vitfinderstorefront/electronics/en",
						"https://electronics.local:9002/vitfinderstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/vitfinderstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/vitfinderstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/vitfinderstorefront/electronics/en",
						"https://electronics.local:9002/vitfinderstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/vitfinderstorefront",
						"https://electronics.local:9002/vitfinderstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/vitfinderstorefront",
						"https://electronics.local:9002/vitfinderstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/vitfinderstorefront/electronics/en",
						"https://electronics.local:9002/vitfinderstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
