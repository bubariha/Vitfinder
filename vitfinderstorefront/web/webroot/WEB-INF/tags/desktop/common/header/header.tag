...
<header class="main-header main-header-md main-header-vtf">
	<div class="container">
		<div class="row">
			...
			<div id="headerNavVtf" class="col-md-7">
				<nav:topNavigation />
			</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12" id="secondaryNavVtf">
				<!-- vtf-206 -->
				<ul class="second-navigation-vtf" id="secondNavigationVtf">
					<li><a href="#">Vitamins</a></li>
					<!-- vtf-1023 -->
					<li><spring:theme code="generalconditions.rootcategory.name"
							var="code" /> <a href="/questionary/generalConditions/${code}">General
							Conditions</a></li>
					...
					<li><spring:theme code="quicktips.rootcategory.name"
							var="code" /> <a href="/quicktips/${code}">Quick Tips</a></li>
