...
<%-- plugins --%>
<script type="text/javascript" src="${commonResourcePath}/js/matchMedia.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/matchMedia.addListener.js"></script>
...
<script type="text/javascript" src="${commonResourcePath}/js/captchaaddon.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/acc.questionary.js"></script>
...
<!-- vtf-40 -->
<script type="text/javascript" src="${commonResourcePath}/js/deliverycost.js"></script>
