...
<div class="col-sm-6 col-md-5 col-lg-5 hidden-xs">
	<div class="checkout-order-summary checkout-order-summary-vtf">
		<div class="headline headline-vtf"><spring:theme code="checkout.multi.order.summary" text="Order Summary" /></div>
