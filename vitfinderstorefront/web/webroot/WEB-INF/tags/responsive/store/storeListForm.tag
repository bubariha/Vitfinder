...
<div class="store-finder js-store-finder store-finder-vtf" data-url="${storeFinderFormAction}"	>
		...
		<div class="row">
			<div class=" col-md-12 col-lg-12">
				...
				<div class="row store-finder-panel">
					<div class="store-finder-navigation store-finder-navigation-vtf">
					...
					<div class="store-finder-details js-store-finder-details">
						...
						<div class="store-finder-details-openings">
							...
							<div class="store-finder-details-openings-title store-features-title-vtf"><spring:theme code="storeDetails.table.features" /></div>
