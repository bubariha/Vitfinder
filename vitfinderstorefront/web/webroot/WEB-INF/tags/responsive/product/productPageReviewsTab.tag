...
<div class="tab-review">
	<div class="review-pagination-bar">
		<button class="btn btn-default js-review-write-toggle gray-btn-vtf"><spring:theme code="review.write.title"/></button>
	...
	<div class="write-review js-review-write">
		<form:form method="post" action="${productReviewActionUrl}" commandName="reviewForm">
			...
			<div class="form-group">
				...
				<div class="rating rating-set js-ratingCalcSet ratingCalcSet-vtf"
					data-rating='{"total":5}'>
					<div class="rating-stars rating-stars-vtf">
			...
			<button type="submit" class="btn btn-primary addtocart-btn-vtf" value="<spring:theme code="review.submit"/>"><spring:theme code="review.submit"/></button>
		</form:form>
