...
<div class="rating js-ratingCalc rating-vtf ${starsClass}" data-rating='{"rating":${product.averageRating},"total":5}'>
	...
	<c:choose>
		<c:when test="${showLinks}" >
			...
			<a href="#tabreview" class="js-writeReviewTab writeReviewTab-vtf"> <i class="fa fa-pencil" aria-hidden="true"></i> <spring:theme code="review.write.title" /></a>
		</c:when>
		<c:otherwise>
