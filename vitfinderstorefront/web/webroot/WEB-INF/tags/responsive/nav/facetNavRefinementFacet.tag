					...
					<c:forEach items="${facetData.topValues}" var="facetValue">
						<li>
									...
									<label>
										...
										<span class="facet-label">
											...
											<span class="facet-text">
												<span class="facet-text-ellipsis-vtf">${facetValue.name}</span>
							...
							<c:if test="${not facetData.multiSelect}">
								...
								<span class="facet-text">
									<a href="${facetValueQueryUrl}&amp;text=${searchPageData.freeTextSearch}"><span class="facet-text-ellipsis-vtf">${facetValue.name}</span></a>&nbsp;
									<ycommerce:testId code="facetNav_count">
										<span class="facet-value-count"><spring:theme code="search.nav.facetValueCount" arguments="${facetValue.count}"/></span>
									</ycommerce:testId>
								</span>
				...
				<c:forEach items="${facetData.values}" var="facetValue">
					<li>
						...
						<c:if test="${not facetData.multiSelect}">
							<c:url value="${facetValue.query.url}" var="facetValueQueryUrl"/>
							<span class="facet-text">
								<a href="${facetValueQueryUrl}"><span class="facet-text-ellipsis-vtf">${facetValue.name}</span></a>
								<ycommerce:testId code="facetNav_count">
									<span class="facet-value-count"><spring:theme code="search.nav.facetValueCount" arguments="${facetValue.count}"/></span>
								</ycommerce:testId>
							</span>
