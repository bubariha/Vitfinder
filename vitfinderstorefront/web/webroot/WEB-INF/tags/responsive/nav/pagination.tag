...
<c:if test="${searchPageData.pagination.totalNumberOfResults > 0}">
	...
	<div class="pagination-bar ${(top)?"top":"bottom"}">
		...
		<div class="row">
			...
			<div class="col-xs-7 col-md-3  pagination-searchR-vtf">
				<ycommerce:testId code="searchResults_productsFound_label">
                    <c:choose>
			...
			<c:if test="${not empty searchPageData.sorts}">
				...
				<div class="col-xs-5 col-md-6 pull-right pagination-searchR-prev-next-vtf">
				...
				<c:if test="${ top}">
					...
					<div class="sort-refine-bar sort-refine-bar-vtf">
						<div class="col-xs-8 col-md-3 pull-right">
							<div class="form-group plp-page-shortby-vtf">
