...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<div class="row">
			...
			<jsp:body>
				<ycommerce:testId code="checkoutStepOne">
					...
					<button id="addressSubmit" type="button"
						class="btn btn-primary btn-block checkout-next addtocart-btn-vtf"><spring:theme code="checkout.multi.deliveryAddress.continue" text="Next"/></button>
				</ycommerce:testId>
			</jsp:body>
		...
		<div class="col-sm-12 col-lg-9">
			<cms:pageSlot position="SideContent" var="feature" element="div" class="checkout-help checkout-help-vtf">
