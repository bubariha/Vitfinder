...
<template:page pageTitle="${pageTitle}">
	...
	<cms:pageSlot position="SideContent" var="feature" element="div"
		class="span-6 side-content-slot cms_disp-img_slot">
	...
	<div class="search-empty">
		<c:choose>
			<c:when test="${not empty searchPageData.freeTextSearch}">
				<div class="headline">
					<spring:theme code="search.no.results"
						text="0 items found for keyword <strong>${searchPageData.freeTextSearch}</strong>"
			...
			<c:otherwise>
				<div class="headline">
					<spring:theme code="search.no.results"
						text='0 items found for keyword <strong>""</strong>'
						arguments='""' />
				</div>
			</c:otherwise>
		</c:choose>
