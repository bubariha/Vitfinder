...
<div class="account-section-content	 account-section-content-small account-section-content-vtf">
	<div class="account-addressbook account-addressbook-vtf">
		...
		<ycommerce:testId code="addressBook_addNewAddress_button">
			<div class="container">
				<div class="col-xs-12 col-sm-6 col-md-3 accountAddAddress">
					<a href="add-address" class="btn btn-primary btn-block addtocart-btn-vtf"><spring:theme code="text.account.addressBook.addAddress" text="Add New Address"/></a>
				</div>
			</div>
		</ycommerce:testId>
					...
					<div class="col-sm-12 col-md-6 col-lg-4 accountAddressItem">
						<div class="remove">
							<ycommerce:testId code="addressBook_removeAddress_button">
								<a class="btn btn-default removeAddressFromBookButton removeAddress-btn-vtf" data-address-id="${address.id}" data-popup-title="<spring:theme code="text.address.delete.popup.title" text="Delete Address"/>">
						...
						<div class="actions">
							<c:if test="${not address.defaultAddress}">
								<ycommerce:testId code="addressBook_isDefault_button">
									<a class="btn btn-default gray-btn-vtf" href="set-default-address/${address.id}">
							...
							<ycommerce:testId code="addressBook_editAddress_button">
								<a class="btn btn-default addtocart-btn-vtf" href="edit-address/${address.id}">
						...
						<div id="popup_confirm_address_removal_${address.id}">
							<div class="addressItem">
								...
								<div class="buttons margin-top-10">
									<a class="btn btn-default closeColorBox gray-btn-vtf" data-address-id="${address.id}">
										<spring:theme code="text.button." text="Cancel"/>
									</a>
									
									<ycommerce:testId code="addressRemove_delete_button">
										<a class="btn btn-default btn-primary delete-btn-vtf" data-address-id="${address.id}" href="remove-address/${address.id}">
