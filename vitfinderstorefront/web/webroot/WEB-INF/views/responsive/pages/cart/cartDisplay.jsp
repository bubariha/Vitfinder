...
<c:if test="${not empty cartData.entries}">
    ...
    <c:set var="showTax" value="false"/>
            ...
            <ycommerce:testId code="cart_totalPrice_label">
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-3 col-md-push-6 col-fullwidth">
                        <button class="btn btn-default btn-block continueShoppingButton gray-btn-vtf " data-continue-shopping-url="${continueShoppingUrl}"><spring:theme text="Continue Shopping" code="cart.page.continue"/></button>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-3 col-md-push-6 col-fullwidth">
                        <ycommerce:testId code="checkoutButton">
                            <a href="/en_GB/cart/checkout" class="btn btn-primary btn-block mini-cart-checkout-button addtocart-btn-vtf"> <spring:theme code="cart.compare"/></a>
                        </ycommerce:testId>
                    </div>
                </div>
