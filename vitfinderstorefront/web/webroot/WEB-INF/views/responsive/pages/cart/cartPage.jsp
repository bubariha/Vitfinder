...
<template:page pageTitle="${pageTitle}">
	...
	<div class="cart-top-bar cart-top-bar-vtf">
			...
			<div class="text-right">
				...
				<div class="help-popup-content-holder js-help-popup-content">
					<div class="help-popup-content">
						...
						<spring:theme code="basket.page.cartHelpContent" arguments="${cartData.code }" text="Need Help? Contact us or call Customer Service at 1-###-###-####. If you are calling regarding your shopping cart, please reference the Shopping Cart ID above." />
					</div>
				</div>
			</div>
	</div>

	<div class="cart-page-vtf">
