		...
		<div id="addToCartLayer" class="add-to-cart">
			...
			<div class="add-to-cart-item">
				...
				<div class="details">
					...
					<a class="name" href="${product.url}">${entry.product.name}</a>
			...
			<ycommerce:testId code="checkoutLinkInPopup">
				<a href="${cartUrl}" class="btn btn-primary btn-block add-to-cart-button addtocart-btn-vtf">
					<spring:theme code="checkout.checkout" />
				</a>
			</ycommerce:testId>


			<a href="" class="btn btn-default btn-block js-mini-cart-close-button gray-btn-vtf">
