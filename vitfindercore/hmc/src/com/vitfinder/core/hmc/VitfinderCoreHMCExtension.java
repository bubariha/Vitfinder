 ...
 *
 */
package com.vitfinder.core.hmc;
...
/**
 * Provides necessary meta information about the vitfindercore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class VitfinderCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(VitfinderCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.vitfinder.core.hmc.locales";
